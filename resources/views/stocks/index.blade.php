        ...
        <table class="table  table-hover table-bordered text-center table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding:0;"><a href="{{asset('/stock/'.{{$s['id'])}}" class="d-block">{{$s->category['name']?? '---'}}</a></td>
              <td style="padding:0;"><a href="{{asset('/stock/'.{{$s['id'])}}" class="d-block">{{$s->device['device-name']?? '---'}}</a></td>
